/*
 * BenchmarksPage4 — Evals 2: Benchmarks
 *
 * Two tabs:
                  ...
                  sortedBenchmarks.map(bm => {
                    ...
                    return (
                      <tr key={bm.id} className="border-b hover:bg-muted/50 cursor-pointer transition-colors"
                        onClick={() => navigate(`/evals2/benchmarks/${bm.id}/runs`)}>
                        ...
                        <td className="px-3 py-2.5 align-middle">
                          {lr ? (
                            <button className="text-[11px] text-blue-400 hover:text-blue-300 hover:underline"
                              onClick={e => { e.stopPropagation(); navigate(`/evals2/benchmarks/${bm.id}/runs/${lr.id}`); }}>
                  ...
                  sortedResults.map(r => (
                    <tr key={`${r.benchmarkId}-${r.runId}-${r.testCaseId}`}
                      ...
                      <td className="px-2 py-2.5 align-middle text-center">
                        ...
                        {r.passed === null && r.resultStatus === 'running' && <Loader2 size={13} className="text-blue-400 animate-spin" />}
